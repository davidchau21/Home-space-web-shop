                        ...
                        <div class="col-md-5 no-padding">                
                            <div class="aa-promo-left">
                                <div class="aa-promo-banner">                    
                                    <img src="${url}/images/may-hut-bui-cam-tay-ariete-mod-2474-dau-hut.jpg" alt="dâu tây Đà Lạt">                    
                                    <div class="aa-prom-content">
                                        <span>Giảm giá 32%</span>
                                        <h4>Máy Hút Bụi Cầm Tay Ariete MOD</h4>                      
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 no-padding">
                            <div class="aa-promo-right">
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/hop-ham-nau-com-magic-a06-b3.jpg" alt="hạt tiêu daklak">                      
                                        <div class="aa-prom-content">
                                            <span>Sản Phẩm độc quyền</span>
                                            <h4>Hộp cơm điện 3 tầng Magic</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/may-pha-ca-phe-espresso-zamboo-zb90-pro-sl1.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                                            <span>Sản phẩm nhập khẩu</span>
                                            <h4>Máy pha cà phê EspresCo</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/am-sieu-toc-inox-1-5-lit-happy-time-htd1055-t3.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                                            <span>Giảm giá 25%</span>
                                            <h4>Ấm siêu tốc Inox</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/may-lam-sua-hat-da-nang-tiross-ts9821-5.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                                            <span>Sản phẩm độc quyền</span>
                                            <h4>Máy Làm Sữa Hạt</h4>                        
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                <li class="active"><a href="#raucu" data-toggle="tab">Quạt - Máy Làm Mát</a></li>
                                <li><a href="#hat" data-toggle="tab">Máy Pha Cà Phê</a></li>
                                <li><a href="#traicay" data-toggle="tab">Máy Hút Bụi </a></li>
                                <li><a href="#matong" data-toggle="tab">Đồ Dùng Nhà Bếp</a></li>
                            </ul>
                            <!-- Tab panes -->
                            ...
                            <div class="more-product">
                                <a class="aa-browse-btn" href="${all}">Xem Tất Cả Sản Phẩm <span class="fa fa-long-arrow-right"></span></a>
                            </div>
            ...
            <div class="col-md-12">        
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="${url}/images/banner-home.jpg" alt="banner trang chủ"></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="aa-support-area">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="aa-support-single">
                            ...
                            <P>Chúng tôi đã áp dụng gói miễn phí vận chuyển cho đơn hàng trên 680.000VNĐ.</P>
                        </div>
                    </div>
                    <!-- single support -->
                    <div class="col-md-4 col-sm-4 col-xs-12">
