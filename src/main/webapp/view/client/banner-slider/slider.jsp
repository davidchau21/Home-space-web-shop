      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/1-min.jpg" alt="Men slide img 1" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/2-min.jpg" alt="Wristwatch slide img 2" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/3-min.jpg" alt="Women Jeans slide img 3" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/4-min.jpg" alt="Shoes slide img 4" />
              </div>
              <div class="seq-title">
